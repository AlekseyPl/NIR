...
void Pdcch::SetDecoder( std::shared_ptr<Decoder> decoder_ )
{
	decoder	= decoder_;
}
...
{
	deinterleaver.PdcchQuadDeinterleaver( q, len, m_nCellId, m_Quad );
	auto sd = reinterpret_cast< SoftDecision* >( &m_Quad[ 0 ] );
